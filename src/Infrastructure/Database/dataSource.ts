...
const hasDatabaseHost = Boolean(process.env.DB_HOST ?? process.env.PGHOST ?? process.env.POSTGRES_HOST);
const databaseHost = process.env.DB_HOST ?? process.env.PGHOST ?? process.env.POSTGRES_HOST ?? "localhost";
const databasePort = toNumber(process.env.DB_PORT ?? process.env.PGPORT ?? process.env.POSTGRES_PORT, 5432);
const databaseName = process.env.DB_DATABASE ?? process.env.DB_NAME ?? process.env.PGDATABASE ?? process.env.POSTGRES_DB ?? "postgres";
